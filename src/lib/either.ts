...
export type Either<S, E = EitherError> = NonNullable<
	ErrorEither<E> | SuccessEither<S>
>

export type EitherError =
	| Error
	| Optional<Erase<Errors.Response, "errors">, "code">
	| Errors.Issue
...
export class EitherNoValueError extends Error {
	public constructor() {
		super()
		this.message =
			"Either require error or success, undefined for both is not accepted"
	}
}
...
Either.isError = <S, E>(e: Either<S, E>): e is ErrorEither<E> =>
	e.error !== undefined

Either.isSuccess = <S, E>(e: Either<S, E>): e is SuccessEither<S> =>
	e.success !== undefined
